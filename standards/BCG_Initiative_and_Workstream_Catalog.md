...
This document is the single source of truth for BCG Corp's active initiatives and workstreams. Every Claude Project references this document (via OneDrive) so that strategic planning, resource allocation, and cross-project coordination use current initiative data rather than stale counts embedded in individual project instructions.
...
| I-07 | Odoo Automated Testing Framework | TBD | Planned | P7 | Q2 '26 | Shared scope with P7-002 Phase A |
...
| I-23 | Odoo Accounting / Financial Baseline | Bob/Victor | On Hold | P7 | Q1 '26 | Blocked — Greg financial data upload needed |
| I-24 | Licensing & Insurance Audit | Greg | Planned | P6 | Q1 '26 | GATING — gates I-16, I-17, I-18, I-19, I-21 |
...
| I-50 | RFP Review SOP & Subproject Framework | Gregory | Active | P2/P8 | Q2 '26 | W-16 draft complete; pending two Gregory decisions (min fee threshold, backup authority); P8-001 setup sequence ready |
...
| WS-02 | Revenue Forecasting & Risk | Greg | Active | P0/P1 | I-34 | Probability-weighted pipeline, DD vs CA backlog. Blocked on Odoo financial data upload. |
| WS-03 | Cash Flow Planning | Greg | Active | P0/P1 | — | Revenue timing by project phase, DD vs CA cash profiles. Blocked on Odoo financial data upload. |
...
| WS-05 | Client Relationship Strategy | Greg | Active | P0/P3 | I-33 | Stakeholder engagement, in-housing defense, direct relationship building. DM playbook (I-33) approved. |
| WS-06 | Standardized Pricing Response | Greg | Active | P0/P1/P3/P8 | I-39 | B&F pricing strategy. P8 provides proposal pricing data and historical calibration. Blocked on P1 financial models and P8 KB population. |
...
| P8 | 1 | I-39. Also serves WS-06 (pricing), WS-07 (capture). |
| P9 | 1 | I-41 |
...
| P7-003 | P7 | Odoo 19 Feature Mining | — | Backlog | Odoo 19 AI assessment, backport candidate list, Odoo 20 watch criteria |
| P7-004 | P7 | Notification Center & Invoice Request | — | Active | bcg_notification_center module — Phase A in progress |

---

## 6. Numbering Conventions

- **Initiatives:** I-01 through I-## (sequential, never reuse removed numbers)
...
| 1.6 | 2026-03-11 | Added I-50 — RFP Review SOP & Subproject Framework (W-16/P8-001). 48 active initiatives. Next slot: I-51. |
---
