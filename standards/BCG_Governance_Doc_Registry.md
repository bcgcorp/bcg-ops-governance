...
**v1.7 Changes:** Complete rewrite. Source-of-truth changed from OneDrive to GitHub per GOV-001 (approved 2026-03-11). Scope updated P0–P8 → P0–P10. Added 9 previously untracked files. Updated all version numbers to current GitHub state. Total: 18 files tracked (14 runtime-fetched, 1 embedded, 1 data file, 1 non-fetchable .docx, 1 self-reference).
...
| 3.2 | `[TEAM] Our Guiding Principles.docx` | — | — | Strategic/culture outputs | BCG's three core principles. Binary .docx — not raw-fetchable. |
...
| 3.4 | `BCG_Team_Directory.md` | — | — | Owner assignment, team references | Roster, titles, emails, project assignments |
| 3.5 | `BCG_Infrastructure_Inventory.md` | 1.1 | — | Deployment plans, security assessments | Compute, network, ERP, AI tools. Note: v1.2 pending (Highland Village + NUC9). |
...
| 3.7 | `BCG_Custom_Module_Registry.md` | 1.0 | — | Odoo module development | All BCG custom Odoo 18 modules |
| 3.8 | `BCG_Artifact_Naming_and_Capture_Standard.md` | — | — | File naming, artifact capture | Naming patterns, capture workflows, folder conventions |
| 3.9 | `BCG_Ecosystem_Vocabulary.md` | 1.0 | 2026-03-08 | Term definitions, agenda generation | Single source for ecosystem terminology |
| 3.10 | `BCG_SOP_Governance_and_Intake_Protocol.md` | 1.0 | 2026-03-08 | SOP creation, intake workflow | SOP creation/approval workflow, intake classification |
| 3.11 | `BCG_W20_Ecosystem_Triage_SOP.md` | 1.0 | 2026-03-08 | P0-001 triage operations | Triage protocol, classification matrix, routing rules |
| 3.12 | `BCG_Ecosystem_Performance_Assessment_Prompt.md` | — | — | Ecosystem assessments, health checks | Tier 1/2/3 assessment checklists, scoring methodology |
| 3.13 | `BCG_pyRevit_Tab_Style_Guide.md` | 1.0 | 2026-03-08 | pyRevit button development | 7-panel BCG tab architecture, icon specs (#1B3A5C) |
| 3.14 | `BCG_P9_Risk_Resilience_Prompt.md` | — | — | Business continuity, risk register | P9 project structure, risk methodology, BCP framework |
| 3.15 | `BCG_Tools_Inventory.md` | — | — | Tool selection, license audits | Software/service inventory, license counts |
...
|------|---------|--------|---------|
| `BCG_Document_Registry.json` | 1.0 | In review | Machine-readable doc status for dashboard |
...
|---------|------|-------------|
| 1.7 | 2026-03-16 | Complete rewrite. GitHub source-of-truth (GOV-001). Scope P0–P10. 18 files tracked. All versions current. |
...
*GitHub at `bcg-ops-governance/standards/` is the single source of truth (GOV-001).*
