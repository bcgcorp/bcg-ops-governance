...
| **Propagation status** | v1.7 fully propagated to all 17 projects (complete 2026-04-19). P0-001 retired; P4-003 added; P0 scope note referencing W-20 v1.2 included. Prior milestone: v1.6 fully propagated 2026-04-15. |
...
| **Supersedes** | `BCG_Ecosystem_Status_2026-04-15.md` (now stale — delete from P0 project knowledge after 2026-04-19 upload) |
